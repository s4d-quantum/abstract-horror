...
export default function SupplierInventory() {
  ...
  const currentSupplier = suppliers.find(s => s.id === parseInt(supplierId));

  const queryParams = {
    page,
    limit: 50,
    search: search || undefined,
    supplier_id: supplierId, // Always filter by this supplier
    ...Object.fromEntries(
    ...
    <div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              {currentSupplier ? currentSupplier.name : 'Supplier'} Inventory
            </h1>
            <p className="text-gray-600 mt-1">
              Viewing all devices from this supplier
            </p>
          </div>
          <button
      ...
      <div className="card">
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">No devices found from this supplier</p>
          </div>
        ) : (
          <>
