...
import { Plus, Search, Package, TruckIcon, CheckCircle, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage sales orders and shipments</p>
        </div>
        <Link
          to="/goods-out/create"
          ...
          <div className="md:col-span-2">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search by SO number, customer, or reference..."
      ...
      <div className="card">
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-2">No sales orders found</p>
            ...
            {!search && !statusFilter && (
              <Link to="/goods-out/create" className="btn btn-primary inline-flex items-center gap-2">
                <Plus className="w-4 h-4" />
                Create Sales Order
              </Link>
            )}
