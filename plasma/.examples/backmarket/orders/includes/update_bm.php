...
if (!$bm_order_id || !$imei || !$tracking_no) {
    die("Usage: php " . basename(__FILE__) . " -oid <BM_ORDER_ID> -imei <IMEI> -tr <TRACKING_NO>\n");
}
...
// $auth_header = "MDZkNjBjNGIyODVlZDQxODFhMjBmZTpCTVQtNWZjZmVmZmNjOWNmZjZmZTM2NWJkNjk2YWEzZDUxZTM0OTYyMGE0ZA==";

$api_url = "https://www.backmarket.fr/ws/orders/{$bm_order_id}";
$auth_header = 'Basic MDZkNjBjNGIyODVlZDQxODFhMjBmZTpCTVQtNWZjZmVmZmNjOWNmZjZmZTM2NWJkNjk2YWEzZDUxZTM0OTYyMGE0ZA==';
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://zebra.quantum-cloud.co.uk/laser');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_POST, true);
