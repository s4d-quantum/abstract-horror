! function (t) {
    ...
    var o = function (t) {
        function e(i, o) {
            ...
            return s.name = "InvalidInputException", s.symbology = i, s.input = o, s.message = '"' + s.input + '" is not a valid input for ' + s.symbology, s
        }
        return i(e, t), e
    }(Error),
        s = function (t) {
    ...
    function s(t, e, n) {
        for (var r = 0; r < t.length; r++) {
            ...
            s.width = Math.ceil(Math.max(u, f)), s.height = i(s, a), s.barcodePadding = o(u, f, a)
        }
    }
    ...
    var f = n(2),
        h = r(f);
    e.getMaximumHeightOfEncodings = u, e.getEncodingHeight = i, e.getBarcodePadding = o, e.calculateEncodingAttributes = s, e.getTotalWidthOfEncodings = a
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {
        value: !0
    ...
    function i(t) {
        ...
        if ("undefined" != typeof HTMLCanvasElement && t instanceof HTMLImageElement) return s(t);
    ...
    var a = n(3),
        ...
        c = function (t) {
            ...
            return s(e, t), e.prototype.valid = function () {
    ...
    function a(t) {
        ...
        return e = i >= 2 ? String.fromCharCode(210) + f(t) : n > r ? String.fromCharCode(208) + u(t) : String.fromCharCode(209) + c(t), e = e.replace(/[\xCD\xCE]([^])[\xCD\xCE]/, function (t, e) {
    ...
    var h = n(3),
        ...
        d = function (t) {
            function e(n) {
                if (i(this, e), n.search(/^[\x00-\x7F\xC8-\xD3]+$/) !== -1) var r = o(this, t.call(this, a(n)));
    ...
    var i = n(16),
        ...
        f = n(15),
        h = r(f);
    e.CODE128 = o["default"], e.CODE128A = a["default"], e.CODE128B = c["default"], e.CODE128C = h["default"]
}, function (t, e) {
    "use strict";
    ...
    var r = function () {
        ...
        return t.prototype.getEncoding = function (t) {
            ...
            for (var t = this.string, e = this.getEncoding("*"), n = 0; n < this.string.length; n++) e += this.getEncoding(this.string[n]) + "0";
            if (this.mod43Enabled) {
                for (var r = 0, i = 0; i < this.string.length; i++) r += this.characterValue(this.string[i]);
                r %= 43, e += this.getBinary(r) + "0", t += this.getCharacter(r)
            }
    ...
    var o = n(0),
        ...
        a = function () {
            function t(e, n) {
                i(this, t), e.search(/^[0-9]{12}$/) !== -1 ? this.string = e + this.checksum(e) : this.string = e, this.displayValue = n.displayValue, this.structure = ["LLLLLL", "LLGLGG", "LLGGLG", "LLGGGL", "LGLLGG", "LGGLLG", "LGGGLL", "LGLGLG", "LGLGGL", "LGGLGL"], n.fontSize > 10 * n.width ? this.fontSize = 10 * n.width : this.fontSize = n.fontSize, this.guardHeight = n.height + this.fontSize / 2 + n.textMargin, this.lastChar = n.lastChar
            }
    ...
    var o = n(0),
        ...
        a = function () {
            function t(e) {
                i(this, t), this.string = e, this.structure = ["LL", "LG", "GL", "GG"]
            }
            return t.prototype.valid = function () {
    ...
    var o = n(0),
        ...
        a = function () {
            function t(e) {
                i(this, t), this.string = e, this.structure = ["GGLLL", "GLGLL", "GLLGL", "GLLLG", "LGGLL", "LLGGL", "LLLGG", "LGLGL", "LGLLG", "LLGLG"]
            }
            return t.prototype.valid = function () {
                ...
                var t = 0;
                return t += 3 * parseInt(this.string[0]), t += 9 * parseInt(this.string[1]), t += 3 * parseInt(this.string[2]), t += 9 * parseInt(this.string[3]), t += 3 * parseInt(this.string[4]), t % 10
            }, t
        }();
    e["default"] = a
}, function (t, e, n) {
    ...
    var o = n(0),
        ...
        a = function () {
            function t(e) {
                i(this, t), e.search(/^[0-9]{7}$/) !== -1 ? this.string = e + this.checksum(e) : this.string = e
            }
            return t.prototype.valid = function () {
    ...
    var o = n(0),
        ...
        a = function () {
            function t(e, n) {
                i(this, t), e.search(/^[0-9]{11}$/) !== -1 ? this.string = e + this.checksum(e) : this.string = e, this.displayValue = n.displayValue, n.fontSize > 10 * n.width ? this.fontSize = 10 * n.width : this.fontSize = n.fontSize, this.guardHeight = n.height + this.fontSize / 2 + n.textMargin
            }
            return t.prototype.valid = function () {
    ...
    var i = n(19),
        ...
        l = n(23),
        d = r(l);
    e.EAN13 = o["default"], e.EAN8 = a["default"], e.EAN5 = c["default"], e.EAN2 = h["default"], e.UPC = d["default"]
}, function (t, e) {
    "use strict";
    ...
    var r = function () {
        function t(e) {
            n(this, t), this.string = e, this.binaryRepresentation = {
                0: "00110",
                1: "10001",
                2: "01001",
                3: "11000",
        ...
        return t.prototype.valid = function () {
            ...
            for (var t = "1010", e = 0; e < this.string.length; e += 2) t += this.calculatePair(this.string.substr(e, 2));
            return t += "11101", {
                data: t,
                text: this.string
            }
        }, t.prototype.calculatePair = function (t) {
            for (var e = "", n = this.binaryRepresentation[t[0]], r = this.binaryRepresentation[t[1]], i = 0; i < 5; i++) e += "1" == n[i] ? "111" : "1", e += "1" == r[i] ? "000" : "0";
            return e
        }, t
    }();
    e.ITF = r
    ...
    var r = function () {
        function t(e) {
            n(this, t), this.string = e, e.search(/^[0-9]{13}$/) !== -1 && (this.string += this.checksum(e)), this.binaryRepresentation = {
                0: "00110",
                1: "10001",
                2: "01001",
                3: "11000",
        ...
        return t.prototype.valid = function () {
            ...
            for (var t = "1010", e = 0; e < 14; e += 2) t += this.calculatePair(this.string.substr(e, 2));
            return t += "11101", {
                data: t,
                text: this.string
            }
            ...
            for (var t = 0, e = 0; e < 13; e++) t += parseInt(this.string[e]) * (3 - e % 2 * 2);
    ...
    var a = n(1),
        ...
        f = function (t) {
            function e(n) {
                i(this, e);
                var r = o(this, t.call(this, n));
                return r.string += (0, c.mod10)(r.string), r.string += (0, c.mod10)(r.string), r
            }
            return s(e, t), e
        }(u["default"]);
    e["default"] = f
    ...
    var a = n(1),
        ...
        f = function (t) {
            function e(n) {
                i(this, e);
                var r = o(this, t.call(this, n));
                return r.string += (0, c.mod11)(r.string), r.string += (0, c.mod10)(r.string), r
            }
            return s(e, t), e
        }(u["default"]);
    e["default"] = f
    ...
    var i = n(1),
        ...
        l = n(31),
        d = r(l);
    e.MSI = o["default"], e.MSI10 = a["default"], e.MSI11 = c["default"], e.MSI1010 = h["default"], e.MSI1110 = d["default"]
}, function (t, e) {
    "use strict";
    ...
    function i(t) {
        ...
        return e.value = t.getAttribute("jsbarcode-value") || t.getAttribute("data-value"), e = (0, s["default"])(e)
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    });
        ...
        u = function () {
            ...
            return t.prototype.render = function () {
                ...
                for (var t = 0; t < this.encodings.length; t++) {
                    var e = (0, s["default"])(this.options, this.encodings[t].options);
                ...
                this.canvas.width = e + this.options.marginLeft + this.options.marginRight,
                    this.canvas.height = n, t.clearRect(0, 0, this.canvas.width, this.canvas.height), this.options.background && (t.fillStyle = this.options.background, t.fillRect(0, 0, this.canvas.width, this.canvas.height)), t.translate(this.options.marginLeft, 0)
    ...
    function a(t, e, n, r, i) {
        ...
        o.setAttribute("x", t), o.setAttribute("y", e), o.setAttribute("width", n), o.setAttribute("height", r), i.appendChild(o)
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    });
        ...
        l = function () {
            ...
            return t.prototype.render = function () {
                ...
                for (var e = 0; e < this.encodings.length; e++) {
                    ...
                    s(i, r), this.drawSvgBarcode(i, r, n), this.drawSVGText(i, r, n), t += n.width
                }
                ...
                for (var o = 0, s = 0, u = 0; u < i.length; u++) s = u * e.width + n.barcodePadding, "1" === i[u] ? o++ : o > 0 && (a(s - e.width * o, r, e.width * o, e.height, t), o = 0);
                ...
                var n = this.svg;
                n.setAttribute("width", t + "px"), n.setAttribute("height", e + "px"), n.setAttribute("x", "0px"), n.setAttribute("y", "0px"), n.setAttribute("viewBox", "0 0 " + t + " " + e), n.setAttribute("xmlns", h), n.setAttribute("version", "1.1"), n.style.transform = "translate(0,0)", this.options.background && (n.style.background = this.options.background)
            }, t
        }();
    e["default"] = l
}, function (t, e, n) {
    ...
    function o(t, e, n) {
        ...
        var i = r.encode();
        i = (0, d["default"])(i);
        for (var o = 0; o < i.length; o++) i[o].options = (0, h["default"])(n, i[o].options);
        return i
    }
    ...
    function a(t, e, n) {
        e = (0, d["default"])(e);
        for (var r = 0; r < e.length; r++) e[r].options = (0, h["default"])(n, e[r].options), (0, g["default"])(e[r].options);
        (0, g["default"])(n);
        var i = t.renderer,
    ...
    var u = n(8),
        ...
        E = function (t, e, n) {
            ...
            return r._renderProperties = (0, v["default"])(t), r._encodings = [], r._options = w["default"], r._errorHandler = new m["default"](r), "undefined" != typeof e && (n = n || {}, n.format || (n.format = s()), r.options(n)[n.format](e, n).render()), r
        };
    E.getModule = function (t) {
        return c["default"][t]
    };
    for (var O in c["default"]) c["default"].hasOwnProperty(O) && i(c["default"], O);
    C.prototype.options = function (t) {
        ...
        if (Array.isArray(this._renderProperties))
            for (var t in this._renderProperties) a(this._renderProperties[t], this._encodings, this._options);
        else a(this._renderProperties, this._encodings, this._options);
        return this
    }, C.prototype._defaults = w["default"], "undefined" != typeof window && (window.JsBarcode = E), "undefined" != typeof jQuery && (jQuery.fn.JsBarcode = function (t, e) {
        var n = [];
