      ...
      <div class="box-body">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <?php $get_date_purchases = mysqli_query($conn,"select * from tbl_non_imei_orders where date='".$date."'")
              or die('Error:: ' . mysqli_error($conn));
             ?>
            <?php while($row = mysqli_fetch_assoc($get_date_purchases)): ?>
            
            <?php $get_purchase_items_query = mysqli_query($conn,"select im.item_code,
            im.item_details,im.item_brand,im.item_qty from  
            tbl_non_imei_products as im inner join tbl_non_imei_orders as pr on 
            pr.item_code = im.item_code where 
            pr.item_code ='".$row['item_code']."'")
              or die('Error:: ' . mysqli_error($conn));
