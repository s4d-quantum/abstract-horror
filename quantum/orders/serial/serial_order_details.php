...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM tbl_serial_orders 
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                invoiceHeader(
                  ...
                  $order_id, 
                  $get_order_details,
                  "Dispatch# : <span class='order_id'>SO-". $order_id."</span>"
                );               
              ?>
                    ...
                    inner join tbl_serial_products as pr on 
                  ...
                  ?>
                    ...
                    <div class="pull-left">
                      ...
                      <b>Courier: </b> <?php echo $get_order_details['delivery_company']; ?>
                    </div>
...
setTimeout(function() {
  ...
  if (window.location.search.indexOf('email') > 1) {
    $.ajax({
      'type': "POST",
      'url': "includes/serial_order_email.php",
      'data': {
        order_id,
        date,
        customer,
...
for (let i = 0; i < items.length; i++) {
  ...
  let na = finalItems.filter(item =>
    ...
    item.grade.toLowerCase() === items[i].grade.toLowerCase()).length;
