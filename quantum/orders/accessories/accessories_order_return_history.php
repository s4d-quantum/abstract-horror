...
// ************
  if(isset($_GET['del'])){
    ...
    while($t = mysqli_fetch_assoc($fetch_order_items)){
      ...
      (
      'AOR-".$return_id."',
      'ACCESSORIES ORDER RETURN DELETED',
      'QTY:".$t['item_qty']."',
      '".$date."',
      ".$user_id.",
      '".$t['product_id']."'
    ...
    // delete order RETURN
    $order_return= mysqli_query($conn,"delete from tbl_accessories_order_return 
    where return_id='".$return_id."'")
    or die('Error:: ' . mysqli_error($conn));

    header("location:accessories_order_return_history.php");
