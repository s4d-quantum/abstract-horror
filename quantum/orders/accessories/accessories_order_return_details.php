...
<?php 
  ...
  tbl_accessories_order_return as ret 
  inner join tbl_accessories_orders as ord 
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                invoiceHeader(
                  ...
                  $order_id, 
                  $return_date,
                  "Return# : <span class='order_id'>AOR-". $order_id."</span>"
                );               
              ?>
                    <br>
                    ...
                    <div class="row">
                      ...
                      pr.product_id,
                      po.item_brand
                      from tbl_accessories_order_return as pr
                      inner join 
