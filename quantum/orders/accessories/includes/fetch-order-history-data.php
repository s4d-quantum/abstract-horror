...
<?php
    ...
    $fetch_total_rows_count = mysqli_query($conn, "select count(distinct order_id) as total from tbl_accessories_orders")
    ...
    $model_query = "SELECT DISTINCT ord.order_id FROM `tbl_accessories_orders` as ord inner join tbl_accessories_products as pr on pr.id = ord.product_id where pr.title LIKE '%".$searchModel."%'";
    ...
    $query = "
        ...
        from tbl_accessories_orders as ord
