...
// // ************
  if(isset($_GET['del'])){
    ...
    tbl_parts_orders where order_id = '".$order_id."'")
    or die('Error:: ' . mysqli_error($conn));
    ...
    // delete order return
    $delete_returns= mysqli_query($conn,"delete from tbl_parts_order_return where 
    order_id ='".$order_id."'");

    // INPUT LOG STARTED
    $fetch_order_items = mysqli_query($conn,"select * from 
    tbl_parts_orders where 
    order_id = '".$order_id."'")
    or die('Error:: ' . mysqli_error($conn));
    ...
    // delete products
    $delete_order= mysqli_query($conn,"delete from tbl_parts_orders where 
    order_id ='".$order_id."'");

    
    header("location:parts_order_history.php");
              ...
              <div class="col-xs-12">
                <div class="box">
                  <div class="box-header">
                    ...
                    <a href="new_parts_order.php" class="btn btn-success pull-right">
