...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM tbl_parts_orders 
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                invoiceHeader(
                  ...
                  $order_id, 
                  $get_order_details,
                  "Dispatch# : <span class='order_id'>PO-". $order_id."</span>"
                );               
              ?>
                    <br>
                    ...
                    <div class="row">
                      <div class="col-xs-12 table-responsive">
                        <table class="table table-bordered items_table">
                          ...
                          <tbody>
                            <?php 
                    $query2 = mysqli_query($conn,"SELECT * FROM tbl_parts_orders 
                    WHERE order_id='".$order_id."' order by tbl_parts_orders.id")
                    or die('error: '.mysqli_error($conn));
                    ...
                    // get product details
                    $get_products_query = mysqli_query($conn,"select * from tbl_parts_products
                    ...
                    ?>
                            <tr>
                              <td>
                                <p class="item_code"><?php echo $product['title']." ".$product['item_color'];?></p>
                        ...
                        <div class="pull-left">
                          <b>PID: </b> <?php echo $get_order_details['linked_pid']; ?><br>
                        </div>
