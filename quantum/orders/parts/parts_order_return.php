...
<?php 
  ...
  // Fetch order details
  $get_order_query = mysqli_query($conn,"Select * from tbl_parts_orders 
  ...
  if(isset($_POST['submit_order'])){
    ...
    header("location:parts_order_return_details.php?ret_id=".$new_ret_id."&email=1");
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <table class="table" id="order_items">
                  ...
                  <tbody>
                    <?php 
                    $order_query = mysqli_query($conn,"Select * from tbl_parts_orders 
                    where order_id='".$ord_id."'")
                    or die('Error:: ' . mysqli_error($conn));
