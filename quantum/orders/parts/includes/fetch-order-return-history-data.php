...
<?php
    ...
    $fetch_total_rows_count = mysqli_query($conn, "select count(distinct return_id) as total from tbl_parts_order_return")
    ...
    if(isset($_POST['return_id'])){
        ...
        from tbl_parts_order_return as ret

        inner join tbl_parts_orders on 
        tbl_parts_orders.order_id = ret.order_id 

        inner join tbl_customers as cst on 
        cst.customer_id = tbl_parts_orders.customer_id 
