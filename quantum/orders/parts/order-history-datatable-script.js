...
const drawTableRow = function (rowsData) {
  ...
  if (!rowsData.length) {
    ...
    rowsData.forEach((val) => {
      let tr = document.createElement("tr");
      let { order_id, date, customer, linked_pid } = val;
      ...
      tr.innerHTML = `<tr>
            ...
            <td>${linked_pid}</td>
            <td>
                <a href="parts_order_return.php?ret=${order_id}"
                    class ="btn bg-gray">
                    Return
                </a>
                <a href="parts_order_details.php?ord_id=${order_id}"
                    class="btn btn-primary">
                    <i class="fa fa-search"></i>
                </a>
                <a href="edit_parts_order.php?ord_id=${order_id}"
