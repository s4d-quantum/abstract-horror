...
$get_email_query = mysqli_query($conn,"select * from tbl_settings")
    ...
    $message = '<h2 style="padding:10px; text-align:center; background:#8ba2bf; color:#ffffff;">Goods Out Report</h2>';
    ...
    $message .= '<thead style="background:#cbd6e4"><th>Activity</th><th>Qty</th></thead>';
