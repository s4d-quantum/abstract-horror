...
<?php
    ...
    $fetch_total_rows_count = mysqli_query($conn, "select count(distinct return_id) as total from tbl_purchase_return")
    ...
    if(isset($_POST['return_id'])){
        ...
        tbl_purchase_return where return_id = ret.return_id) as total 

        from tbl_purchase_return as ret

        inner join tbl_purchases as pur on 
