...
// fetch suppliers
  ...
  if(isset($_GET['del'])){
    ...
    // delete IMEI QC 
    $delete_qc_imei = mysqli_query($conn,"delete from tbl_qc_imei_products 
    where purchase_id='".$purchase_id."'")
    or die('Error:: '.mysqli_error($conn));

    // delete IMEI
    $new_imei = mysqli_query($conn,"delete from tbl_imei where 
    purchase_id ='".$purchase_id."'") 
    or die('Error:: ' . mysqli_error($conn));
  ...
  // INPUT LOG ENDED
    ...
    // delete purchases    
    $new_purchase_return = mysqli_query($conn,"delete from tbl_purchases 
    where purchase_id = '".$purchase_id."'")
    or die('Error:: '.mysqli_error($conn));
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Goods In</h3>
              <a href="new_purchase.php" class="btn btn-success pull-right">
