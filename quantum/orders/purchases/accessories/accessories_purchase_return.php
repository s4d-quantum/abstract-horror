...
<?php 
  ...
  tbl_accessories_purchase_return")
  ...
  // Fetch order details
  $get_purchase_query = mysqli_query($conn,"Select * from tbl_accessories_purchases 
  ...
  if(isset($_POST['submit_purchase'])){
    ...
    for($i = 0;$i<count($_POST['item_code']);$i++){
      ...
      $qty = isset($_POST['item_qty'][$i]) ? (int)$_POST['item_qty'][$i] : 0;
      if($qty > 0){
        ...
        tbl_accessories_purchase_return (
          ...
          set item_qty = item_qty - ".$qty." where 
    ...
    header("location:accessories_purchase_return_details.php?ret_id=".$new_ret_id."&email=1");
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <table class="table" id="purchase_items">
                  ...
                  <tbody>
                    <?php 
                    $purchase_query = mysqli_query($conn,"Select * from tbl_accessories_purchases 
                    where purchase_id='".$pur_id."'")
                    or die('Error:: ' . mysqli_error($conn));
...
<script src="accessories_purchase_return_script.js"></script>
<script>
 // date picker
