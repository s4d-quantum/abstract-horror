...
// ************
  if(isset($_GET['del'])){
    ...
    for($i = 0;$i<count($item_array);$i++){
      ...
      // update products qty
      $new_imei = mysqli_query($conn,"update tbl_accessories_products set
      ...
      while($t = mysqli_fetch_assoc($fetch_purchase_items)){
        ...
        (
        'APR-".$purchase_id."',
        'ACCESSORIES PURCHASE RETURN DELETED',
        'QTY:".$t['item_qty']."',
        '".$date."',
        ".$user_id.",
        '".$t['product_id']."'
      ...
      // delete order RETURN
      $order_return= mysqli_query($conn,"delete from tbl_accessories_purchase_return 
      where return_id='".$return_id."'")
      or die('Error:: ' . mysqli_error($conn));


    header("location:accessories_purchase_return_history.php");
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Accessories Returns</h3>
            </div>
            <div class="box-body">
