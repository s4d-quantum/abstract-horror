...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM tbl_parts_purchases 
                      ...
                      <thead>
                        ...
                        <tr>
                          <td>
                            ...
                            <br>
                            <b>P.ID :</b>
                            <span class="purchase_id">PP-<?php echo $purchase_id; ?></span>
                            <br>
                            <b>Supplier :</b>
                    ...
                    <div class="row">
                      <div class="col-xs-12 table-responsive">
                        <table class="table table-bordered items_table">
                          ...
                          <tbody>
                            <?php 
                      $query2 = mysqli_query($conn,"SELECT * FROM tbl_parts_purchases 
                      WHERE purchase_id='".$purchase_id."'")
                      or die('error: '.mysqli_error($conn));
                      $no = 0;
