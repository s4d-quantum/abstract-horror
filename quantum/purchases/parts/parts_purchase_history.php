...
// // ************
  if(isset($_GET['del'])){
    ...
    $returns_rs = mysqli_query(
      ...
      "SELECT product_id, SUM(item_qty) AS qty
       FROM tbl_parts_purchase_return
    ...
    tbl_parts_purchases where purchase_id = '".$purchase_id."'")
    or die('Error:: ' . mysqli_error($conn));
    ...
    $delete_returns= mysqli_query($conn,"delete from tbl_parts_purchase_return where 
    purchase_id ='".$purchase_id."'");

    // INPUT LOG STARTED
    $fetch_purchase_items = mysqli_query($conn,"select * from 
    tbl_parts_purchases where 
    purchase_id = '".$purchase_id."'")
    or die('Error:: ' . mysqli_error($conn));
    $item_array= array();
  ...
  // INPUT LOG ENDED
    ...
    // delete products
    $delete_purchase= mysqli_query($conn,"delete from tbl_parts_purchases where 
    purchase_id ='".$purchase_id."'");
    
    header("location:parts_purchase_history.php");
              ...
              <div class="col-xs-12">
                <div class="box">
                  <div class="box-header">
                    ...
                    <a href="new_parts_purchase.php" class="btn btn-success pull-right">
