...
<?php 
  ...
  tbl_accessories_purchase_return as ret 
  inner join tbl_accessories_purchases as pur 
  on ret.purchase_id = pur.purchase_id 
  
  where ret.return_id='".$purchase_id."'")
...
where supplier_id='".$return_date['supplier_id']."'");
...
if(isset($_POST['export-to-excel']) || isset($_POST['download_report'])){
  ...
  // $filename = $_POST["ExportType"] . ".xls";		 
    $filename = "PRID#".$_GET['ret_id']."_".$get_supplier['name']."_".$return_date['date']."_.xls";		 
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                invoiceHeader(
                  ...
                  $purchase_id, 
                  $return_date,
                  "Return# : <span class='order_id'>APR-". $purchase_id."</span>"
                );               
              ?>
                    <br>
                    ...
                    <div class="row">
                      ...
                      pr.product_id,
                      po.item_brand
                      from tbl_accessories_purchase_return as pr
                      inner join 
                      tbl_accessories_products as po 
                      on po.id = pr.product_id 
                      where pr.return_id='".$purchase_id."'")
                      or die('error: '.mysqli_error($conn));
                    ...
                    ?>
                        ...
                        <textarea name="" id="" cols="30" rows="5"
                          class="form-control comment-box"><?php echo $return_date['report_comment']; ?></textarea>
