...
<?php
    ...
    $fetch_total_rows_count = mysqli_query($conn, "select count(distinct return_id) as total from tbl_accessories_purchase_return")
    ...
    if(isset($_POST['return_id'])){
        ...
        from tbl_accessories_purchase_return as ret

        inner join tbl_accessories_purchases on 
        tbl_accessories_purchases.purchase_id = ret.purchase_id 

        inner join tbl_suppliers as sup on 
        sup.supplier_id = tbl_accessories_purchases.supplier_id 
