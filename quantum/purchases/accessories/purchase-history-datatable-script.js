...
const drawTableRow = function (rowsData) {
  ...
  rowsData.forEach((val) => {
        ...
        `<tr>
            ...
            <td>
                <a href="accessories_purchase_return.php?ret=${purchase_id}"
                    class="btn bg-gray">
                    Return
                </a>
                <a href="accessories_purchase_details.php?pur_id=${purchase_id}"
                    class="btn btn-primary">
                    <i class="fa fa-search"></i>
                </a>
                <a href="edit_accessories_purchase.php?pur_id=${purchase_id}"
