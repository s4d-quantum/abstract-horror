...
$get_email_query = mysqli_query($conn,"select * from tbl_settings")
    ...
    $name = "S4D Limited";
    $email = 'warehouse@s4dlimited.com';

    $message = '<h2 style="padding:10px; text-align:center; background:#8ba2bf; color:#ffffff;">Goods In Report</h2>';
    ...
    mail($recipient, $subject, $messag, $mailheader) 
    or die("Error!");