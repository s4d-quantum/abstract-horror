  ...
  <div class="content">
    <div class="row">
      <div class="col-md-12">
        ...
        <label for="" style="width:10%;">
          <select placeholder="Color" class="form-control select-color">
            ...
            <?php 
                    ...
                    ?>
            <option value="<?php echo $color['item_color'];?>"><?php echo $color['item_color'];?></option>
            <?php 
                  }
                endwhile; ?>
          </select>
        ...
        <label for="" style="width:10%;">
          <select placeholder="GB" class="form-control select-gb">
            ...
            <option value="1028">1028 GB</option>
          </select>
        </label>
        ...
        <button class="apply-filters btn btn-success" style="width:20%;">
          Apply filters
        </button>
