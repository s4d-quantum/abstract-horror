...
if(isset($_POST['export-to-excel'])){
  ...
  $item_array= array();
  for($i=0;$i < count($_POST['item_serial']); $i++){
    $item_array[] = array(
      'PID' => '="'.$_POST['pur_id'][$i].'"',
          ...
          <div class="row">
           <div class="col-md-12">
              ...
              <div style="width:45%;" class="filter-group pull-left">
                <input type="text" class="pull-left form-control search-model-input" 
                  placeholder="Search Model"
                  style="width:75%;padding:22px 20px !important; font-size:22px;" 
                  >
                  <button style="width:23%" class="pull-right btn btn-success btn-lg search-model">Apply filters</button>
              </div>
                  ...
                  <div class="box-body custom_datatable_wrapper">
                    ...
                    <div class="custom_datatable">
                      ...
                      <!-- <form action="" method="post"> -->
                        ...
                        <table class="export-table hide" id="export-table">
                        <thead>
                            <tr>
                              <th>P.ID</th>
                              <th>Code</th>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Search Summary</h4>
...
<script src="serial-datatable-script.js"></script>
</body>
</html>