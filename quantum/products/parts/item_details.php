...
inner join tbl_parts_purchases as pu 
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="form-group col col-md-3 col-sm-6">
                <label>Color</label>
                <P style="border:1px solid #eaeaea;padding:2px 3px;">
                  <?php echo isset($get_item['item_color']) ? $get_item['item_color'] : '-'; ?></P>
              </div>
            ...
            <table class="table">
              ...
              <tbody>
                <?php 
                  ...
                  where item_code=".$item_code." AND subject lIKE '%PARTS%' ORDER BY id DESC")                
                ...
                <tr>
                  ...
                  <td>
                    ...
                    tbl_parts_products where id=".$row['item_code']);
