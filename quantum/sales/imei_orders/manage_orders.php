            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-header">
                  <h3 class="box-title">Manage IMEI Sales Orders</h3>
                  <a href="manage_all_orders.php" class="btn btn-default pull-right" title="Show BM Orders (All)" style="margin-right:10px;">
                    <i class="fa fa-exchange"></i> Show BM Orders
                  </a>
                  <?php 
