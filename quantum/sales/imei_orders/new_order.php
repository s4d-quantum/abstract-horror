                  ...
                  <div class="box-body" style="max-height:400px; overflow-y:scroll;">
                    <div class="row">
                      <div class="form-group col col-md-3 col-sm-6">
                        ...
                        <input type="text" class="form-control purchase_color" placeholder="Any Color" list="purchase-color-options">
                        <datalist id="purchase-color-options"></datalist>
                      </div>
                      <div class="form-group col col-md-3 col-sm-6">
                        <label>Filter by OEM Color</label>
                        <input type="text" class="form-control purchase_oem_color" placeholder="Any OEM Color" list="purchase-oem-color-options">
                        <datalist id="purchase-oem-color-options"></datalist>
                      </div>
                      <div class="form-group col col-md-2 col-sm-4">
                        <label>&nbsp;</label>
                        <button type="button" class="btn btn-default form-control clear-color-filter">Clear Filters</button>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col col-md-3">
                        <label>PO Reference</label>
                          <input type="text" required class="form-control po_ref" name="po_ref" />
                      </div>

                      <div class="form-group col col-md-3">
                        <label>Customer Ref#</label>
                          <input type="text" required class="form-control customer_ref" name="customer_ref" />
                      </div>
...
<script src="sales_order_script.js"></script>
<script>
  window.console.log = () => {}
</script>
</body>
