            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-header">
                  <h3 class="box-title">Manage All IMEI Sales Orders</h3>
                  <a href="manage_orders.php" class="btn btn-default pull-right" title="Hide BM Orders" style="margin-right:10px;">
                    <i class="fa fa-exchange"></i> Hide BM Orders
                  </a>
                  <?php 
                  ...
                  <!-- initialize include_bm to true for this page -->
                  <input type="hidden" id="include_bm_default" value="1">
...
<script src="manage_order_script.js"></script>
