...
<?php 
  ...
  $fetch_basic_data = mysqli_query($conn,"select customer_id, po_ref, customer_ref, user_id from 
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col col-md-3">
                        <label>Customer Ref#</label>
                          <input type="text" required class="form-control customer_ref" 
                          value="<?php echo $fetch_data['customer_ref'];?>" name="customer_ref" />
                      </div>
